...
public class IPv4RadixIntTree {
     ...
     */
    private IPv4RadixIntTree(int allocatedSize) {
        init(allocatedSize);
    }
     ...
     * @throws IOException
     */
    private static IPv4RadixIntTree loadFromLocalFile(String filename, boolean nginxFormat) throws IOException {
    ...
    public static void main(String[] args) throws UnknownHostException {
        ...
        int v3 = tr.selectValue("10.0.5.5"); // => 123, as 10.0.3.5 belongs to 10.0.3.0/24
     ...
     */
    private void put(long key, long mask, int value) {
...
//            }
     ...
     * address
     */
    private int selectValue(long key) {
        long bit = MAX_IPV4_BIT;
        int value = NO_VALUE;
        int node = ROOT_PTR;
     ...
     * most specific value available for a given address.
     *
     * @param ipStr key IPv4 address to look up, in string form (i.e. "a.b.c.d")
     * @return value at most specific IPv4 network in a tree for a given IPv4
     * address
     * @throws UnknownHostException
     */
